                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="body d-flex justify-content-between align-items-center mb-3">
                                <h4 class="card-title">Kategoryalar</h4>
                                ...
                                <tbody>
                                    @foreach ($categories as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-link p-0" href="{{ route('admin.category.edit', $data->id) }}" data-bs-toggle="tooltip"
...
@section('admin.js')
    ...
    <script>
        function changeStat(id, status) {
            ...
            var url = '{{ env('APP_URL ') }}/admin/category/status/' + id;
            $.ajax({
                url: `${url}`,
                dataType: 'json',
                data: {

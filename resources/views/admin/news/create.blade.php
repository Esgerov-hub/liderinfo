                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="title"   name="title[az]" value="" placeholder="Başlıq...">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" rows="2" name="text[az]" placeholder="Mətn..."></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="summernote-height form-control" rows="2" name="full_text[az]" placeholder="Mətn..."></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
